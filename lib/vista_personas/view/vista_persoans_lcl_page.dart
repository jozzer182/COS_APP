...
class PersonasLclBigPage extends StatefulWidget {
  final String correo;
  const PersonasLclBigPage({
    required this.correo,
    super.key,
  });

  @override
  State<PersonasLclBigPage> createState() => _PersonasLclBigPageState();
}

class _PersonasLclBigPageState extends State<PersonasLclBigPage> {
  String filter = '';
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainBloc, MainState>(
      builder: (context, state) {
        ...
        valores = valores
            .where((e) => e.correo == widget.correo)
            .where(
            ...
            .toList();
        valores.sort((a, b) => a.vencido.compareTo(b.vencido));
        valores = valores.reversed.toList();
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text("VISTA POR LCL (Millones de pesos) ${widget.correo} "),
            actions: [
              // ElevatedButton(
              //   onPressed: () {
              //     List<Map<String, dynamic>> datos = [];
              //     for (LclBigReg bigLcl in valores) {
              ...
              //       datos: datos,
              //       nombre: "Conformidades ${widget.correo}",
              //     );
              //   },
              //   child: const Text(
              //     'Descargar\nConformidades',
