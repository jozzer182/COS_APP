...
class VistaContratoPage extends StatefulWidget {
  const VistaContratoPage({super.key});

  @override
  State<VistaContratoPage> createState() => _VistaContratoPageState();
}

class _VistaContratoPageState extends State<VistaContratoPage> {
  String filter = '';
  int endList = 70;
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainBloc, MainState>(
      builder: (context, state) {
        ...
        List<ToCelda> titulos = state.vistaContratoList?.celdas ?? [];
        List<VistaContratoReg> valores = state.vistaContratoList?.list ?? [];
        valores = valores
            .where(
              (e) => e.toList().any(
            ...
            .toList();
        List<VistaContratoReg> valoresToShow = [];
        ...
        return Scaffold(
          appBar: AppBar(
            title: const Text("VISTA POR CONTRATO (Millones de pesos)"),
                ...
                Expanded(
                  child: SelectableRegion(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (c, index) {
                        // print(valoresToShow[index].contrato);
